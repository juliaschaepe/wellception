...
1. If you need to change the parameters of your sherlock job, for example how long you need the GPU for, you can edit the `params_deepcell.sh` file to reflect that. For processing an entire experiment, you will likely need at least a day `24:00:00`. The maximum time that you can request on Sherlock is 2 days, `2:00:00:00`
